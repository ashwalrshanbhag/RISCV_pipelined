module decode_cycle(clk, rst, InstrD, PCD, PCPlus4D, RegWriteW, RDW, ResultW,
    ...
    // Interim Wires (combinational outputs from submodules)
    ...
    // FlushE=1: insert a NOP bubble (all control signals zeroed, rd=x0)
    // FlushE=0: latch the decoded instruction normally
